...
BASE_URL='http://192.168.1.5:8181/employee'    
default_args = {
    'owner': 'airflow',
...
printing_data = BashOperator(
    task_id='t2',
    bash_command='echo "{{ json.loads(ti.xcom_pull("save-employee")) }}"',
    dag=dag
)


health_check_task >> save_employee_task >> printing_data >> get_all_employee_task
